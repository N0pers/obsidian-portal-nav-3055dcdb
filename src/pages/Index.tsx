    ...
    <div className="flex min-h-screen flex-col items-center justify-between px-4 py-8">
      ...
      <div className="flex flex-col md:flex-row gap-8 items-center justify-center py-8">
        ...
        >
          ...
          <span className="relative z-10 text-base mt-3 font-rajdhani">Launch</span>
        ...
        >
          ...
          <span className="relative z-10 text-base mt-3 font-rajdhani">Explore</span>
        ...
        >
          ...
          <span className="relative z-10 text-base mt-3 font-rajdhani">Discover</span>
